...
establishes the database connection, and registers the application routes.
...
async def start_up_span():
    ...
    database, attaching the client and database instances to the 
...
async def shutdown_span():
    ...
    that database and vector DB connections are properly closed to prevent leaks.
    """
    await app.db_engine.dispose()
    print("Closed MongoDB connection")  
    await app.vectordb_client.dis_connect()
